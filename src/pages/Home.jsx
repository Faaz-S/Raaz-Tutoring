      ...
      <section className="relative bg-white overflow-hidden">
        <div className="container mx-auto flex flex-col lg:flex-row items-center px-4 py-12 lg:py-24">
          <div className="lg:w-1/2 mb-8 lg:mb-0">
            ...
            <p className="mt-6 text-xl font-bold text-blue-900 tracking-wide">Explore Our Programs Here</p>
            <div className="mt-6 space-y-4 flex flex-col w-64">
              <NavLink
                to="/grades-7-9"
                className="border-4 border-blue-900 text-blue-900 px-4 py-2 rounded-lg font-semibold text-lg transition hover:bg-orange-500 hover:text-white text-center"
              >
                Grades 7-9
              </NavLink>
              <NavLink
          ...
          <div className="lg:w-1/2 relative">
            <div className="absolute -left-16 -top-16 w-62 h-62 bg-blue-100 rounded-full mix-blend-multiply filter blur-3xl opacity-50" />
            <img
